...
var (
	...
	TextGreetingMsg = emoji.ChristmasTree.String() + emoji.ChristmasTree.String() + emoji.ChristmasTree.String() + "Привет, %s\n\n" +
		...
		"/add - если ты зашел в игровую команту, то ты можешь добавить игроков у которых нет телеграмма. Виртуальныхигроков, их задания будут приходить тебе. Ты можешь дать им свой смартфон, когда подойдет их очередь играть\n\n" +
