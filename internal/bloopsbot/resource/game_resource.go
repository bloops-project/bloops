...
var (
	...
	Bloopses = []Bloops{
		...
		{Name: emoji.Mage.String() + " Маг", Weight: 2, Seconds: +15, Points: +10, Task: "Магический водоворот, маг говорит, чтобы выиграть нужно назвать дополнительно одно слово на магическую или фэнтэзи на тему на выпавшую букву"},
		...
		{Name: emoji.HighVoltage.String() + " Высокое напряжение", Weight: 2, Seconds: +15, Points: +15, Task: "Ты напряжен, ведь это супер игра, тебе нужно придумать слова, и когда на таймере останется 10сек назвать все слова разом!"},
		...
		{Name: emoji.Brain.String() + " Вундеркинд", Weight: 2, Seconds: +30, Points: +10, Task: "Твой IQ зашкаливает и ты пришел всех поразить, в этом раунде тебе нужно назвать ОДНО слово, но не начинающееся, а заканчивающееся на выпавшую букву!"},
		{Name: emoji.CrystalBall.String() + " Гадалка", Weight: 2, Task: "Ты решил попробовать себя в астрологии, до начала раунда игрок напротив загадывает одну из категорий(используемых в игре), если ты угадал, то выигрываешь раунд автоматом(нажми стоп на таймер сразу после начала), если нет играешь как обычно."},
	}
)
