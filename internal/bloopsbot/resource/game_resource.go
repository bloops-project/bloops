...
var (
	...
	Bloopses = []Bloops{
		...
		{Name: emoji.FourLeafClover.String() + " Четырехлистный клевер", Weight: 2, Task: "Ты прогуливался как-то по лесу и увидел его - четырехлистый клевер. Удача! Ты можешь заменить выпавшую букву на любую другую"},
