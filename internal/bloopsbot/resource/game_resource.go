...
var (
	...
	Bloopses = []Bloops{
		...
		{Name: emoji.FourLeafClover.String() + " Четырехлистный клевер", Weight: 3, Task: "Ты прогуливался как-то по лесу и увидел его - четырехлистый клевер. Удача! Ты можешь заменить выпавшую букву на любую другую"},
		...
		{Name: emoji.MoneyBag.String() + " Казино", Weight: 2, Task: "Ты любитель перекинуться в картишки и казино предлагает тебе сделку, подбрось монетку, если выпадет орел - ты выигрываешь раунд сразу(жми на стоп на таймере сразу), если нет - проигрываешь(ждешь окончание таймера и не играешь) Что ты выбираешь?"},
		{Name: emoji.TestTube.String() + " Мамихлапинатапаи", Weight: 2, Task: "Ты нечайно оказался на вечеринке со студентами и они предложили тебе задачку, можешь 5 раз произнести слово Мамихлапинатапаи подряд и нажать стоп на таймере или играть раунд как обычно. Выбор за тобой"},
	}
)
